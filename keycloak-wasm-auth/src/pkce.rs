...
pub(crate) fn generate_random_string(length: usize) -> Result<String, AuthError> {
...
pub(crate) fn generate_code_challenge(verifier: &str, method: &Challenge) -> String {
    match method {
        Challenge::S256 => {
            // SHA256 hash
...
pub(crate) fn generate_state() -> Result<String, AuthError> {
